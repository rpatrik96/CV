...
\item[]\textbf{From Superposition to Sparse Codes: Interpretable Representations in Neural Networks.}
D. Klindt, C. O'Neill, {\color{customblue}\textbf{Patrik Reizinger}}, H. Maurer, N. Miolane.
\emph{Nature Machine Intelligence} (accepted, 2026).
...
\item[]\textbf{Position: An Empirically Grounded Identifiability Theory Will Accelerate Self-Supervised Learning Research} (the \textbf{SITH} programme).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cventry{2026.12.}{Developing Research Taste in the Era of AI-assisted Research}{BethgeLab Compounding Intelligence Workshop}{Tübingen, Germany}{}{}
...
\cvitem{\en{Reviewing}{Bíráló}}{JMLR; ICML 2025/2026 position paper track; ICLR 2025/2026; NeurIPS 2024/2025; CLeaR 2024/2025; AISTATS 2026; UAI 2026; NeurIPS 2023/2024 workshops; Infocommunications Journal}
...
\href{https://github.com/rpatrik96/identifiability-guard}{\emph{identifiability-guard}} --- benchmark framework for testing identifiability metrics\newline
\href{https://github.com/rpatrik96/latex-code-sync}{\texttt{latex-code-sync}} --- keep LaTeX numerical results in sync with the experiments that produced them%
}
...
\cvitem{Soft skills}{%
\textbf{Leadership} (NeurIPS 2024 CALM Workshop; IMPRS-IS Bootcamp; ELLIS Doctoral Symposium);
\textbf{Scientific writing} (\emph{Path to PhD} newsletter; reviewing for ICML/ICLR/NeurIPS/CLeaR/AISTATS);
...
\textbf{Storytelling} (15+ invited talks since 2022 at Mila, LMU Munich, Waterloo, et al.)
}
